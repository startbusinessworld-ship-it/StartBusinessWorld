...
;(function() {
  ...
  var PLANS_PAYANTS = ['inscrit', 'intro', 'basic', 'pro', 'business', 'mensuel', 'annuel']
  var PLAN_LEVELS = { 'inscrit': 2, 'intro': 2, 'basic': 2, 'pro': 3, 'business': 4, 'mensuel': 4, 'annuel': 4 }
  var PLAN_PRICES = { 'mensuel': '79', 'annuel': '597' }
